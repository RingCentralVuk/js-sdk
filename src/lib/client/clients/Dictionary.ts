...
export class Dictionary extends client.Client {
    ...
    public listCountries(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/country', options, listCountriesOptions),
    ...
    public loadCountry(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/country/{countryId}', options, loadCountryOptions),
    ...
    public listLanguages(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/language', options, listLanguagesOptions),
                            null);
    ...
    public loadLanguage(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/language/{languageId}', options, loadLanguageOptions),
    ...
    public listLocations(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/location', options, listLocationsOptions),
    ...
    public listStates(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/state', options, listStatesOptions),
     ...
     * <p>Light</p>
     */
    public loadState(options?:{
        /** Internal identifier of a state */
        'stateId':string;
    }):Promise<getstateinforesponse.GetStateInfoResponse> {

        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/state/{stateId}', options, loadStateOptions),
    ...
    public listTimezones(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/timezone', options, listTimezonesOptions),
    ...
    public loadTimezone(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/dictionary/timezone/{timezoneId}', options, loadTimezoneOptions),
