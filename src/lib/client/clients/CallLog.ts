...
export class CallLog extends client.Client {
    ...
    public listActiveCalls(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/active-calls', options, listActiveCallsOptions),
    ...
    public list(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/call-log', options, listOptions),
    ...
    public load(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/call-log/{callRecordId}', options, loadOptions),
    ...
    public loadRecording(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/account/{accountId}/recording/{recordingId}', options, loadRecordingOptions),
