...
export class RingOut extends client.Client {
    ...
    public create(options?:{
        ...
        return this.apiCall(this.parseOptions('post', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/ringout', options, createOptions),
    ...
    public load(options?:{
        ...
        return this.apiCall(this.parseOptions('get', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/ringout/{ringoutId}', options, loadOptions),
                            getringoutstatusresponse.GetRingOutStatusResponse);
    ...
    public remove(options?:{
        ...
        return this.apiCall(this.parseOptions('delete', '/restapi/v1.0/account/{accountId}/extension/{extensionId}/ringout/{ringoutId}', options, removeOptions),
                            null);
